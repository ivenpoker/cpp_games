...
void TicTacToe::evaluate_program(int game_code)  {
    ...
    switch (game_code) {
        case INVALID_BOARD_STATE:
            cerr << "Invalid board state detected";
        ...
        case INVALID_INDEX_POSITION:
            cerr << "Cannot operate on the chosen indices" << endl; break;

        case INVALID_PLAYER_CODE:
            cerr << "Invalid player code." << endl;
            break;
        case INVALID_PLAYER1_MOVE:
            cerr << "Invalid player 1 (X) move." << endl;
            break;
        case INVALID_PLAYER2_MOVE:
            cerr << "Invalid player 2 (O) move." << endl;
            break;
...
void TicTacToe::dipslay_board() {
    ...
    cout << "Player 1 (X) at [" << player1_pos->x_pos << ", " << player1_pos->y_pos << "] "
         << " and Player 2 (O) at [" << player2_pos->x_pos << ", " << player2_pos->y_pos << "]" << endl;
}
